...
const mutableGalleryItems: MutableMedia[] = [
  {
    ...
    title: "Draft",
    alt: "Draft render",
    preview: { src: "/draft-preview.jpg", width: 600, height: 400 },
    full: { src: "/draft.jpg", width: 1_200, height: 800 },
    credit: "Studio",
  },
  {
    id: "final",
    title: "Final",
    alt: "Final render",
    preview: { src: "/final-preview.jpg", width: 600, height: 400 },
    full: { src: "/final.jpg", width: 1_200, height: 800 },
    credit: "Studio",
  },
];
